...
router.route('/')
    ...
    .post(authController.protect, studentExamController.checkDate, studentExamController.checkIsCreated, studentExamController.setQuestions, studentExamController.setDates, studentExamController.createStudentExam);

...
router.route('/')
    ...
    .post(authController.protect, studentExamController.checkIsCreated, studentExamController.setQuestions, studentExamController.setDates, studentExamController.createStudentExam);
